...
<body>
    ...
    <!--导航条-->
    <div class="width100" style="height: 45px;background: #DB7093;margin-top: 40px;position: relative;z-index: 100;">
        <!--中间的部分-->
        <div class="width1200 center_yh relative_yh" style="height: 45px;background: #DB7093">
            <!--普通导航-->
...
<div class="width1200 hidden_yh center_yh font20">全部花卉<font class="red">（${fn:length(list)}）</font> </div>
<div class="width1198 hidden_yh center_yh" style="border: 1px solid #ddd;margin-top: 18px;min-height: 300px;">
    ...
    background: #f0f0f0;text-indent: 21px;color: #000; font-weight: 600;border-bottom: 1px solid #ddd;">花卉详情</div>
    <div class="width100 hidden_yh fon14" style="height: 42px;line-height: 42px;border-bottom: 1px solid #ddd;">
        <div class="left_yh tcenter font14" style="width: 470px;">花卉</div>
        <div class="left_yh tcenter font14" style="width: 185px;">价格</div>
        <div class="left_yh tcenter font14" style="width: 180px;">数量</div>
        <div class="left_yh tcenter font14" style="width: 180px;">小计</div>
        <div class="left_yh tcenter font14" style="width: 65px;">操作</div>
    </div>
    <c:forEach items="${list}" var="data" varStatus="l">
        <div class="speCific" data-id="${data.id}">
            ...
            <div class="xzJg" >
                ￥<font>${data.price*data.zk}</font> 原价￥${data.price}
...
<div class="width1198 center_yh" style="height: 60px;background: #f0f0f0;border:1px solid #ddd;margin-top:40px;">
    <div class="center_yh hidden_yh" style="width: 1178px;height: 60px;margin-left: 20px;">
        ...
        <div class="sXd">
            <div class="sXd1">已选花卉（<font style="color: #cb1c20">0</font> ）</div>
